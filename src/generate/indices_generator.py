card_sets = [
    ...
    ['Starting Mission Cards Fronts', 1, 97],
    ['Starting Mission Cards Backs', 2, 97],
    ['Staged Mission Cards Fronts', 97, 181],
    ['Staged Mission Cards Backs', 98, 181],
    ['Single Player Fronts', 1, 69],
    ['Single Player Backs', 2, 69],
    ['Two Player Fronts', 69, 207],
    ['Two Player Backs', 70, 207],
